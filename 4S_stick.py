# 4S_stick.py (Version 4.1 - Fixed base blend file handling)
...
CONFIG_FILE = "4S_stick_config.json"
BASE_BLEND_FILE = "4S_stick_base.blend"
EDIT_SCRIPT = "4S_stick_inner.py"
...
def main():
    ...
    # Load local config for stick-specific settings
    ...
    # Build the correct output path for the final stick figure animation
    ...
    output_blend_file = os.path.join(outputs_dir, f"{scene_name}_stick.blend")
    ...
    script_log("Launching Blender with 4S_stick_inner.py...")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            script_log(f"Stick figure animation saved to: {output_blend_file}")
        else:
