...
CONFIG_FILE = "4M_cloth_config.json"
BASE_BLEND_FILE = "4K_kid_base.blend"
INNER_SCRIPT = "4M_cloth_inner.py"
...
def main():
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    inner_script_path = os.path.join(script_dir, INNER_SCRIPT)
    ...
    output_blend_file = os.path.join(outputs_dir, f"{scene_name}_cloth.blend")
    ...
    script_log("Launching Blender with 4M_cloth_inner.py...")
